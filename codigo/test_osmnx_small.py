...
nodos.to_file("evidencia/datos/nodos_centro_valpo.gpkg", driver="GPKG")
aristas.to_file("evidencia/datos/aristas_centro_valpo.gpkg", driver="GPKG")
print("Guardado en evidencia/datos/")

fig, ax = ox.plot_graph(G, show=False, close=False, node_size=3, edge_linewidth=0.6)
fig.savefig("evidencia/imagenes/mapa_centro_valpo.png", dpi=150)
print("Mapa guardado en evidencia/imagenes/mapa_centro_valpo.png")
